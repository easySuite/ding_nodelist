(function ($) {
    ...
    Drupal.behaviors.video_play = { //VIMEO, YOUTUBE AND SOUNCLOUD CUSTOM PLAY-BUTTONS
        attach: function (context, settings) {
            ...
            if ($(".media-content .content > div").hasClass("media-vimeo-video")) {
                mediasrc = "vimeo";
            }
            else if ($(".media-content .content > div").hasClass("media-youtube-video")) {
                mediasrc = "yt";
            }
            else if ($(".media-content .content > div").hasClass("media-soundcloud-audio")) {
                mediasrc = "sc";
            }
            ...
            if (video_play_once === 0) {
                if (mediasrc === "yt") {
                    ...
                    $('.media-soundcloud-player').attr('id', 'soundcloud_widget');
                }
                video_play_once = 1;
            }
            ...
            $('.media-play', context).on('click', function (event) {
                ...
                var $this = $(this),
                    ...
                    url = top.children('.media-container').children('.media-content').data('url'),
                    stripurl,
                    mediasrc,
                    mediaurl,
                    iframe;

                top.children('.media-container').children('.close-media').show(); //show the close btn
                ...
                if (url.indexOf("vimeo") != -1) {
                    ...
                    //append the video
                    top.children('.media-container').children('.media-content').append(iframe);
                }
